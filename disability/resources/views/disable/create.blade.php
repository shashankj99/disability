    ...
    <div class="row mb-2">
        ...
        <div class="col-12 col-sm-6 col-md-9 mb-2">
            <div class="text-center">
                <h1 class="m-0 text-dark">नयाँ अपाङ्ग व्यक्ती दर्ता गर्नुहोस्</h1>
            </div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('disable.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @include('disable._form', ['districtNames' => $districtNames, 'localLevelNames' => $localLevelNames, 'numberConverter' => $numberConverter, 'buttonText' => 'दर्ता गर्नुहोस्'])
            </form>
        </div>
    </div>
